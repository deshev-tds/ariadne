<script>
	...
	import News from './Settings/News.svelte';
	import Maps from './Settings/Maps.svelte';
				...
				<div class=" self-center mr-2">
					...
					{:else if tab.id === 'news'}
						<svg
							...
							class="w-4 h-4"
						>
							<path d="M4.5 4.5A2.25 2.25 0 0 1 6.75 2.25h10.5A2.25 2.25 0 0 1 19.5 4.5v15a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 19.5v-15Z" />
							<path fill="white" d="M8.25 7.125h7.5v1.5h-7.5zm0 3.75h7.5v1.5h-7.5zm0 3.75h4.5v1.5h-4.5z" />
						</svg>
					{:else if tab.id === 'maps'}
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						>
							<path
								fill-rule="evenodd"
								d="M12 2.25a7.5 7.5 0 0 0-7.5 7.5c0 5.06 5.236 10.303 6.545 11.546a1.35 1.35 0 0 0 1.91 0C14.264 20.053 19.5 14.81 19.5 9.75a7.5 7.5 0 0 0-7.5-7.5Zm0 10.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
								clip-rule="evenodd"
							/>
						</svg>
