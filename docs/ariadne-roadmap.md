...
- materialize bounded lesson candidates from eligible diary packets
- write them into the internal lessons catalog, not directly into markdown
- keep model-facing cards generated by the existing builder
