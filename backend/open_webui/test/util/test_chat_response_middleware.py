...
@pytest.mark.asyncio
async def test_non_streaming_chat_response_uses_machine_cautious_fallback_when_repair_yields_no_answer(
    monkeypatch,
):
    saved_messages = []
                ...
                "goals": [
                    {
                        ...
                        "acceptance_contract": {
                            ...
                            "forbidden_as_sole_support_classes": [
                                "secondary_summary",
                                "mirror_or_index",
                            ],
                ...
                "evidence_ledger": [
                    {
                        ...
                        "source_ref": {
                            "title": "Frontiers review",
                            "url": "https://example.test/review",
                            "domain": "example.test",
                        },
                        "canonical_url": "https://example.test/review",
                        "evidence_family_id": "doi:10.1000/review",
                        "identifier_hints": {"doi": "10.1000/review"},
                        "evidence_class": "systematic_synthesis",
                        "stance": "supports",
                        "directness": "direct",
                        ...
                        "value_bucket": "medium",
                        "limitations": ["broader fallback not completed"],
                        "blocked": False,
                        "text_preview": "Current evidence from RCTs does not support significant effects on sleep latency.",
                    }
                ],
                "repair_pass_count": 0,
            },
